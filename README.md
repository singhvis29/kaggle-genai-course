...
10. When developing Gen-AI use case, it is sometimes required to fine-tune the model directly, fine-tuning lets us change one or more layers of LLM to output a more desired output. Two method to fine-tune an LLM is Supervised Fine-Tuning, Reinforcement Learning from Human Feedback (RLHF).
11. 
